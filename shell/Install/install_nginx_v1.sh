...
##安装nginx
cd /root ;  wget  https://www.openssl.org/source/openssl-1.0.2g.tar.gz  ; tar zxf  openssl-1.0.2g.tar.gz
cd  openssl-1.0.2g ;  ./config  ; make ;  make install ; openssl version
cd /root  ;  wget  http://nginx.org/download/nginx-1.12.0.tar.gz  ;tar  zxf  nginx-1.12.0.tar.gz 
cd  nginx-1.12.0 
