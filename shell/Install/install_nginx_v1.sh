...
./configure  --prefix=/usr/local/nginx --user=www --group=www --with-http_stub_status_module --with-http_ssl_module --with-http_realip_module --with-http_geoip_module --with-stream  --with-stream_realip_module   --with-http_v2_module   --with-openssl=/root/openssl-1.0.2g
make  && make  install
